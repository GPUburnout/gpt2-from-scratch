"""
Training Script with Real-Time Graph Visualization
Trains the Transformer model with live plotting of metrics
"""
...
class TrainingVisualizer:
    ...
    def __init__(self):
        ...
        self.fig.suptitle('Training Progress - Tiny Language Model', fontsize=14, fontweight='bold')
    ...
    def setup_plots(self):
        ...
        self.ax1.legend(['Train Loss', 'Val Loss'])

        # Perplexity plot
        self.ax2.set_xlabel('Epoch')
        self.ax2.set_ylabel('Perplexity')
        self.ax2.set_title('Training & Validation Perplexity')
        self.ax2.grid(True, alpha=0.3)
        self.ax2.legend(['Train Perplexity', 'Val Perplexity'])
    ...
    def update(self, epoch, train_loss, val_loss):
        ...
        # Plot loss
        self.ax1.plot(self.epochs, self.train_losses, 'b-o', label='Train Loss', linewidth=2, markersize=6)
        self.ax1.plot(self.epochs, self.val_losses, 'r-s', label='Val Loss', linewidth=2, markersize=6)
        self.ax1.set_xlabel('Epoch', fontsize=11)
        self.ax1.set_ylabel('Loss', fontsize=11)
        self.ax1.set_title('Training & Validation Loss', fontsize=12, fontweight='bold')
        self.ax1.grid(True, alpha=0.3)
        self.ax1.legend(fontsize=10)

        # Plot perplexity
        self.ax2.plot(self.epochs, self.train_perplexities, 'b-o', label='Train Perplexity', linewidth=2, markersize=6)
        self.ax2.plot(self.epochs, self.val_perplexities, 'r-s', label='Val Perplexity', linewidth=2, markersize=6)
        self.ax2.set_xlabel('Epoch', fontsize=11)
        self.ax2.set_ylabel('Perplexity', fontsize=11)
        self.ax2.set_title('Training & Validation Perplexity', fontsize=12, fontweight='bold')
        self.ax2.grid(True, alpha=0.3)
    ...
    def save(self, filepath='models/tiny_lm_v1/training_plot.png'):
        """Save the final plot"""
...
def main():
    ...
    print("\n" + "="*80)
    print("TRAINING TINY LANGUAGE MODEL (WITH LIVE GRAPHS)")
    print("="*80)
    ...
    # Create visualizer
    print("\nInitializing live graphs...")
    visualizer = TrainingVisualizer()

    # Training loop
    print("\n" + "="*80)
    print("STARTING TRAINING (Watch the graphs update in real-time!)")
    print("="*80)
    ...
    metadata = {
        ...
        'dataset': {'name': 'tiny_shakespeare', 'size': f'{len(text):,} characters'},
        'training': {
    ...
    print(f"Training plot saved to: models/tiny_lm_v1/training_plot.png")
    print(f"\nNext step: Generate text or chat with your model!")
